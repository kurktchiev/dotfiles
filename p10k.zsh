# Generated by Powerlevel10k configuration wizard on 2020-05-22 at 15:16 CEST.
...
() {
  ...
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='%003F${P9K_KUBECONTEXT_CLUSTER}%245F@%006F${P9K_KUBECONTEXT_NAMESPACE}'
